  ...
  const features = [
    {
      icon: Calendar,
      title: "O Evento",
      description: "Confira todos os detalhes do nosso grande dia 💍",
      link: "/evento",
      color: "rose",
    },
    {
      ...
      description: "Sua presença é o maior presente!💛 Mas se quiser, temos uma listinha especial 😉",
    ...
    },
    {
      icon: Camera,
      title: "Galeria",
      description: "Veja nossas fotos do pré-wedding ✨",
      link: "/galeria",
      color: "rose",
    },
    {
      ...
      description: "Conta pra gente se você vem! 🎉",
